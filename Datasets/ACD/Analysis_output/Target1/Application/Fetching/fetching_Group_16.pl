...
my $fasta_library;
my %records;
open IDFILE, "/home/arjen/HMMERCTTERv15/FinalStudies/ACD/Target/Application/Groups/Group_16.txt" or die $!;
open OUTPUT, ">fetching_Group_16.txt" or die$!;
#  name of the library file - (here it is hardcoded)
$fasta_library='/home/arjen/HMMERCTTERv15/FinalStudies/ACD/Target/ApSeqFile';
