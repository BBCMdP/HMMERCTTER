...
my $fasta_library;
my %records;
open IDFILE, "/home/arjen/1_Local/1_HMMerCTTer/16/PGCleanTarget/4Target/Application/Groups/Group_3.txt" or die $!;
open OUTPUT, ">fetching_Group_3.txt" or die$!;
#  name of the library file - (here it is hardcoded)
$fasta_library='/home/arjen/1_Local/1_HMMerCTTer/16/PGCleanTarget/4Target/ApSeqFile';
